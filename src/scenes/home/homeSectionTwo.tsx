    ...
    <div>
      <div className="w-full">
        <div className="">
          ...
          <div className="mx-auto w-[50%] text-center text-white drop-shadow-[0_2px_2px_rgba(0,0,0,1)] xs:mt-[-30%] xs:text-base sm:mt-[-25%] sm:text-2xl md:mt-[-25%] md:text-4xl lg:mt-[-25%] lg:text-5xl">
